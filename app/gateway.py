...
# === KONFIGURASI EKSTERNAL (dashboad web tim) ===
# SEMUA host/channel Redis memakai app.settings (satu sumber kebenaran).
WEB_HOST = cfg.NGROK_HOST  # domain dashboard (ngrok/VPS)
...
VISION_CHANNEL = cfg.VISION_CHANNEL
MISSION_CHANNEL = cfg.MISSION_CHANNEL
COMMAND_CHANNEL = "asv_commands"  # channel khusus perintah dari web
# ===================
